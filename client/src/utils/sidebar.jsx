            ...
            <div className="relative h-screen m-0 p-0">
                ...
                >
                    <div className="absolute top-20 left-5 flex flex-col space-y-10">
                        <div onClick={()=>setselect(0)}className={`flex items-center ${select===0?'bg-mint-green p-3 rounded':'text-white'}`}>
                        ...
                        <div onClick={()=>setselect(1)} className={`flex items-center ${select===1?'bg-mint-green p-3 rounded':'text-white'}`}>
                        ...
                        <div onClick={()=>setselect(2)} className={`flex items-center ${select===2?'bg-mint-green p-3 rounded':'text-white'}`}>
                        ...
                        <div onClick={()=>setselect(3)} className={`flex items-center ${select===3?'bg-mint-green p-3 rounded':'text-white'}`}>
                        ...
                        <div onClick={()=>setselect(4)} className={`flex items-center ${select===4?'bg-mint-green p-3 rounded':'text-white'}`}>
                        ...
                        <div onClick={()=>setselect(5)} className={`flex items-center ${select===5?'bg-mint-green p-3 rounded':'text-white'}`}>
                        ...
                        <div onClick={()=>setselect(6)} className={`flex items-center ${select===6?'bg-mint-green p-3 rounded':'text-white'}`}>
                        ...
                        <div onClick={()=>setselect(7)} className={`flex items-center ${select===7?'bg-mint-green p-3 rounded':'text-white'}`}>
